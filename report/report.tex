...
\subsection{问题描述}
分析一个在中心受高斯分布载荷作用的方形板 ($1\text{m} \times 1\text{m}$，厚度 $t=0.05\text{m}$)。四边均为简支 ($w=0$)。材料属性为 $E=210$ GPa 和 $\nu=0.3$。
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \hline
        中心挠度 $w_{max}$ (m) & -2.727938e-04 &   -4.72757e-04  \\
        \hline
        最大 Von Mises 应力 (Pa) &  2.572139e+07 & 7.07667e+07 \\
        \hline
    \end{tabular}
\end{table}
